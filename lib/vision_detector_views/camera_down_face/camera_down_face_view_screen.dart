...
import 'down_face_detector_painter.dart';

class CameraDownFaceViewScreen extends StatefulWidget {
  CameraDownFaceViewScreen({
    Key? key,
  ...
  @override
  State<CameraDownFaceViewScreen> createState() =>
      _CameraDownFaceViewScreenState();
}

class _CameraDownFaceViewScreenState extends State<CameraDownFaceViewScreen> {
  static List<CameraDescription> _cameras = [];
  DownFaceDetectorPainter? facePainter;
    ...
    widget.faceDetector.processImage(inputImage).then((faces) {
      if (faces.isNotEmpty) {
        ...
        if (inputImage.metadata?.size != null &&
          ...
          //   face: face,
          //   canvasSize: Utils.DownFaceCanvasSize,
          //   imageSize: inputImage.metadata!.size,
          //   checkMatchedNotifier: checkMatchedNotifier,
          // );
          facePainter = DownFaceDetectorPainter(
            face: face,
            imageSize: inputImage.metadata!.size,
