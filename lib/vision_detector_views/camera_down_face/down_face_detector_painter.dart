...
class DownFaceDetectorPainter extends CustomPainter {
  DownFaceDetectorPainter({
    required this.face,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    print('''
      ...
      down-degree $left $top $right $bottom $size $imageSize
  ...
  @override
  bool shouldRepaint(DownFaceDetectorPainter oldDelegate) {
    // return false;
