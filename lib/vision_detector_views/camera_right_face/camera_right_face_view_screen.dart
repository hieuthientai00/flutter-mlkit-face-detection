...
import '../../utils.dart';
import 'right_face_detector_painter.dart';

class CameraRightFaceViewScreen extends StatefulWidget {
  CameraRightFaceViewScreen({
    Key? key,
  ...
  @override
  State<CameraRightFaceViewScreen> createState() =>
      _CameraRightFaceViewScreenState();
}

class _CameraRightFaceViewScreenState extends State<CameraRightFaceViewScreen> {
  static List<CameraDescription> _cameras = [];
  CameraController? _controller;
  RightFaceDetectorPainter? facePainter;
  int _cameraIndex = -1;
    ...
    widget.faceDetector.processImage(inputImage).then((faces) {
      if (faces.isNotEmpty) {
        ...
        if (inputImage.metadata?.size != null &&
          ...
          facePainter = RightFaceDetectorPainter(
              painter: painter,
              face: face,
